...
<div class="container p-10">
    <div class="row">
        <div class="col-md-10 col-sm-10 mx-auto">
            <div class="tile">
                <form action="{{ route('advertise.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @if (count($errors) > 0)
                        ...
                        <div class="card-body">  
                            ...
                            <div class="form-group label-floating" id="advertise_type">
                                ...
                                <select name="ads_type" id="ads_type" class="form-control">
                                    ...
                                    <option value="2">Vertical Ads (height)</option>
                                    <option value="3">Horizontal Ads (width)</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group label-floating" id="hide_status">
                            ...
                            <div class="tile-footer">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a class="btn btn-sm btn-danger btn-square btn-uppercase" href="{{ route('advertise.index') }}"><i class="fa fa-fw fa-sm fa-times-circle"></i>Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
