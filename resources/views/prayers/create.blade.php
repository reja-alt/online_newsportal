...
<div class="container p-10">
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="tile">
                <form action="{{ route('prayer.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @if (count($errors) > 0)
                    ...
                    <div class="card">
                        <div class="card-body">  
                            ...
                            <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="prayer_name_bn" id="prayer_name_bn" value="{{ old('prayer_name_bn') }}"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="prayer_name_en"> Prayer English Name<span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control" type="text" name="prayer_name_en" id="prayer_name_en" value="{{ old('prayer_name_en') }}"/>
                            </div>               
