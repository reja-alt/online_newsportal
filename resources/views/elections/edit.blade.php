    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('election.update',$election->id) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @if (count($errors) > 0)
                    ...
                    <div class="card">
                        <div class="card-body">  
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title_en" id="title_en" value="{{$election->title_en }}"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="title_bn">Title Bangla<span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control" type="text" name="title_bn" id="title_bn" value="{{ $election->title_bn }}"/>
                            </div>
                        
                            <div class="form-group">
                                <label class="control-label" for="description_en">Description English<span class="m-l-5 text-danger"> *</span></label>
                                <textarea class="form-control" id="summernote" name="description_en"  >{{ $election->description_en }}</textarea>
                            </div> 
                            <div class="form-group">
                                <label class="control-label" for="description_bn">Description Bangla<span class="m-l-5 text-danger"> *</span></label>
                                <textarea class="form-control" id="summernote2" name="description_bn"  >{{ $election->description_bn }}</textarea>
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="hidden" name="old_image" value="{{$election->image}}">
                                </div>
                            </div>
