...
@section('meta')
  ...
  <meta property="og:title" content="{{$show_opinion_post->title_bn}}" />
  <meta property="og:description" content="{{$show_opinion_post->details_bn}}" />
  <meta property="og:image" content="{{asset('uploads/post')}}/{{$show_opinion_post->image}}" />
@endsection
            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-details-desc">
                    ...
                    <div class="article-image">
                        <img src="{{asset('public/uploads/post')}}/{{$show_opinion_post->image}}" alt="image" style="width: 800px; height: 550px;">
                    </div>

                    <div class="article-content">
                    <span><a href="#">{{$writer->bangla_name}}</a> / {{ \Carbon\Carbon::parse($show_opinion_post->created_at)->format('j F, Y')}} / <a href="#">{{$show_opinion_post->view}} View</a></span>
                        <h3 style="font-size: 32px; font-family:SolaimanLipi; line-height: 38px; font-weight: 500;">{{$show_opinion_post->title_bn}}</h3>
                        <p>{{$show_opinion_post->details_bn}}</p>
                    </div>
                    ...
                    <div class="post-navigation">
                        <div class="navigation-links">
                            <div class="nav-previous">
                                ...
                                <a href="{{ URL::To( 'opinionshow/'. $previous->slug_bangla ) }}">
                                    <i class='bx bx-chevron-left'></i>
                                    Prev Post
                                </a>
                            </div>
                            <div class="nav-next">
                                <a href="{{ URL::To( 'opinionshow/'. $next->slug_bangla ) }}">
                                    Next Post 
                        ...
                        <div class="health-news-slides owl-carousel owl-theme">
                            ...
                            <div class="single-health-news">
                                ...
                                <div class="health-news-content">
                                    <span></span>
                                    <h3>
                                        <a href="{{route('opinion.show',$related_post->slug_bangla)}}">{{$related_post->title_bn}}</a>
                                    </h3>
                    ...
                    <div class="related-posts section-title">
                        ...
                        @foreach($related_posts->take(5) as $related_post)
                            <div class="col-md-4 mt-3">
                                <a class="related-items" href="{{route('postshow.show',$related_post->id)}}">
                                    <img src="{{asset('uploads/post')}}/{{$related_post->image}}" class="img-thumbnail" style="width: 500px; height: 200px;"/>
                                </a>
                            </div>
                        @endforeach
                        </div>
