            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-details-desc">
                    ...
                    <div class="article-image">
                        <img src="{{asset('public/uploads/post')}}/{{$show_lifestyle_post->image}}" alt="image" style="width: 800px; height: 550px;">
                    </div>

                    <div class="article-content">
                    <span><a href="#">{{$writer->bangla_name}}</a> / {{ \Carbon\Carbon::parse($show_lifestyle_post->created_at)->format('j F, Y')}} / <a href="#">{{$show_lifestyle_post->view}} View</a></span>
                        <h3 style="font-size: 32px; font-family:SolaimanLipi; line-height: 38px; font-weight: 500;">{{$show_lifestyle_post->title_bn}}</h3>
                        <p>{{$show_lifestyle_post->details_bn}}</p>
                    </div>
                    ...
                    <div class="post-navigation">
                        <div class="navigation-links">
                            ...
                            <div class="nav-next">
                                <a href="{{ URL::To( 'lifestyleshow/'. $next->slug_bangla ) }}">
                                    Next Post 
                        ...
                        <div class="health-news-slides owl-carousel owl-theme">
                            ...
                            <div class="single-health-news">
                                ...
                                <div class="health-news-content">
                                    <span></span>
                                    <h3>
                                        <a href="{{route('lifestyle.show',$related_post->slug_bangla)}}">{{$related_post->title_bn}}</a>
                                    </h3>
                                    <p><a href="#">{{$writer->bangla_name}}</a> /{{ \Carbon\Carbon::parse($related_post->published_date)->format('j F, Y')}}</p>
                                </div>
                            </div>
                                @endforeach
