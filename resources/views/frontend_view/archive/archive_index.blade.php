...
@section('front_content')
    ...
    <section class="container mt-3 p-4" style="background-color: rgba(221, 219, 219, 0.315)">
            <center><h3 class="mb-3" >সব খবর</h3></center>
                ...
                <div class="row mr-5 ml-5">
                        <div class="col-sm-6">
                            <div class="input-group">
                                <div class="input-group-addon mt-2" style="font-size: 13px">তারিখ <i class="fa fa-calendar mr-2"></i></div>
                                <input placeholder="Date" class="form-control mr-3" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
                                        <div class="input-group-addon"  style="font-size: 13px">থেকে <i class="fa fa-calendar mr-2"></i></div>
            ...
            <div class="row m-4">
                ...
                <div class="row mt-4 pl-2">
                    @php
                        $posts=DB::table('posts')->orderBy('id','DESC')->paginate(20);
                            ...
                            <div class="row align-items-center mr-1" style="background-color: rgb(253, 253, 253);">
                                <div class="col-lg-4 col-sm-4 p-0">
                                    <div class="sports-news-image">
                                        <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$post->image}}" alt="image" style="width: 170px; height: 100px;" >
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-sm-8">
                                    <div class="sports-news-content">
                                        <span></span>
                                        <h3 style="font-size: 14px; font-name: SolaimanLipi; font-weight: 500; line-height: 26px;">
