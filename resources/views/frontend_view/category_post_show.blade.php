...
@php
$advertisements= DB::table('advertisements')->where('ads_type',3)->orderBy('id','ASC')->take(2)->get(); 
@endphp
<div class="container">
 <div class="row">
   @foreach ($advertisements as $advertisement)
        <div class="col-lg-6">
            <a href="{{$advertisement->ads_link}}">
                <img src="{{asset('public/uploads/ads')}}/{{$advertisement->ads_image}}" >
            </a>
        </div>    
      @endforeach    
 </div>
          ...
          <div class="page-title-area">
            <div class="container">
                ...
                <h2>{{$category->name_bn}}</h2>
                    <ul>
                    <li><a href="{{route('frontend.home-show')}}">হোম</a></li>
                        <li>{{$category->name_bn}}</li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row ">
                            ...
                            @if($post->category_first_section == 1)
                            <div class="col-lg-6">
                                <div class="single-sports-news-box">
                                    <div class="sports-news-image">
                                        <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$post->image}}" alt="image" style="width: 340px; height: 250px;">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">       
                                    <div class="sports-news-content ">
                                        ...
                                        <h3 style="font-size: 15px; font-name: SolaimanLipi; font-weigth: 400; line-height: 26px; margin-left: -50px;">
                        ...
                        <div class="row">
                            @foreach ($posts as $post)
                            @if($post->thumbnail_select == 0 && $post->category_first_section != 1)
                            <div class="col-lg-6">
                    ...
                    <section class="widget widget_featured_reports">
                        <div class="single-featured-reports">
                            <div class="featured-reports-image">
                                <a href="#">
                                    <img src="{{asset('public/uploads/ads')}}/{{$advertisement_side->ads_image}}" alt="image" style="height: 150px; width: 1000px; margin-top: 30px;">
                                </a>
