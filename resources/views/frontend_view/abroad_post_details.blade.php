        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="blog-details-desc">
                    ...
                    <h3 style="font-size: 30px; font-family:SolaimanLipi; line-height: 38px; font-weight: 500;"><a href="{{route('abroad.show',$show_post->slug_bangla)}}">{{$show_post->title_bn}}</h3>
                        <h4 class="title usmall"><a href="#" style="font-size: 16px; font-family: SolaimanLipi; font-weight: 400; line-height: 38px; color: rgb(8, 8, 8);" >{{($show_post->details_bn)}}</a></h4>
                    </div>
                        ...
                        <div class="health-news-slides owl-carousel owl-theme">
                            ...
                            <div class="single-health-news">
                                ...
                                <div class="health-news-content">
                                    <h3>
                                        <a href="{{route('abroad.show',$related_post->slug_bangla)}}">{{$related_post->title_bn}}</a>
                                    </h3>
                                </div>
                            </div>
                                @endforeach
