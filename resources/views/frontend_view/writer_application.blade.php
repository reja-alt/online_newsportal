                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="contact-form">
                            <div class="title">
                                <h3>লেখক হিসেবে আমাদের সাথে সংযুক্ত হতে ইচ্ছুক ? </h3>
                            ...
                            @endif
                            <form action="{{route('store.writer.application')}}" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="address" class="form-control" id="address" required data-error="Please enter your Address" placeholder="Address" required="">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="education" class="form-control" id="education" required data-error="Please enter your Highest Education" placeholder="Highest Education" required="">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="passing_year" class="form-control" id="passing year" required data-error="Please enter your passing year" placeholder="Passing year" required="">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
