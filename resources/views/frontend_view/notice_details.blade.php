...
@section('meta')
  ...
  <meta property="og:image" content="{{asset('uploads/post')}}/{{$post->image}}" />
@endsection
            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-details-desc">
                    <div class="article-image">
                        <img src="{{asset('public/uploads/post')}}/{{$post->image}}" alt="image" style="width: 800px; height: 550px;">
                    </div>
                    <div class="article-content">
                   
                        <h3 style="font-size: 32px; font-family:SolaimanLipi; line-height: 38px; font-weight: 500;">{{$post->title_bn}}</h3>
                        <p>{{$post->details_bn}}</p>
                    </div>
                        ...
                        <div class="health-news-slides owl-carousel owl-theme">
                            ...
                            <div class="single-health-news">
                                ...
                                <div class="health-news-content">
                                    <span></span>
                                    <h3>
                                        <a href="{{route('notice.show',$related_post->slug_bangla)}}">{{$related_post->title_bn}}</a>
                                    </h3>
