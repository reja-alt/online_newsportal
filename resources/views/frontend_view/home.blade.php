...
@if($offon->header_ads==1) 
    <div class="row">
      @foreach ($advertisements_first as $advertisement_first)
        <div class="col-lg-6">
            <a href="{{$advertisement_first->ads_link}}">
                <img src="{{asset('public/uploads/ads')}}/{{$advertisement_first->ads_image}}" >
            </a>
        </div>    
      @endforeach    
    </div>
    ...
    <div class="container mt-2">
        <div class="breaking-news-content">
            <div class="single-breaking-news" >
                <br>
                 <h6 class="breaking-title mr-1" style="font-size: 18px;color:rgb(0, 0, 0);  font-weight: 600; font-family: sans-serif; ">
                    শিরোনাম : 
                 </h6>
            </div>
            ...
            <div class="breaking-news-slides owl-carousel owl-theme">
                @php
                    $headlines=DB::table('posts')->orderBy('id','DESC')->where('headline',1)->limit(20)->get();
                @endphp
               
                <div class="single-breaking-news p-1" style="background-color: #5a0505"> 
                   <marquee direction="left" onmouseover="this.stop()" onmouseout="this.start()"> @foreach ($headlines as $headline)<a href="{{route('postshow.show',$headline->slug_bn)}}" style="font-family: solaimanlipi; font-size: 16px; font-weight: 400; color:rgb(245, 248, 248)">{{$headline->title_bn}} <i class='fa fa-dot-circle-o pl-1 pr-1' style="color: rgb(0, 132, 255)"></i></a> @endforeach </marquee>
                </div>   
            </div>
        </div>
    </div>
...
<section class="new-news-area pt-3">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <div class="single-new-news-box pb-2"  style="background-color: #F4F6F6;">
                    <div class="new-news-image">
                        <a href="#">
                            @isset($post->image)
                            <img src="{{asset('public/uploads/post/'.$post->image)}}" class="post-img p-3" style="width: 900px; height: 400px;"> 
                            @endisset
                        </a>
                        <div class="new-news-content" >
                            <h5 style="font-size: 22px; font-family: Solaiman Lipi Regular; font-color: #000000; margin-top: -20px; margin-left: 5px;">
                                @isset($post->slug_bn)
                                <a href="{{route('postshow.show',$post->slug_bn)}}">{{$post->title_bn}}</a>
                                @endisset
                            </h5>
                        </div><br>
                        @isset($post->details_bn)
                        <h6 style="font-size: 14px; line-height: 26px; font-family: Solaiman Lipi Regular; font-color: #000000; margin-top: -20px; margin-left: 20px; font-weight: 400;">{!! str_limit($post->details_bn,840,'....') !!}</h6>
                        @endisset
                    </div>    
                </div>    
            </div> 
            <div class="col-lg-3">
                @foreach ($post_smalls as $post_small)
                <div class="single-new-news"  style="background-color: #f8fcfc;">
                    <div class="new-news-image">
                        <a href="#">
                            <img src="{{asset('public/uploads/post')}}/{{$post_small->image}}" style="width: 250px; height: 150px;" >
                        </a>
                        <div class="new-news-content">
                            <h3 class="m-1" style="font-size: 16px; font-family: Solaiman Lipi; font-color: #000000; line-height: 26px;">
                            <a href="{{route('postshow.show',$post_small->slug_bn)}}">{{$post_small->title_bn}}</a>
                            </h3> 
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="daily-briefing-item">
                    <div class="title" style="background-color: #dbe2e2;">
                        <h3 class="text-center pt-3">মতামত</h3>
                    </div>
                        @php
                            $opinions=DB::table('opinions')->orderBy('id','DESC')->skip(1)->take(7)->get();
                        @endphp
                        @foreach ($opinions as $opinion)
                        <div class="row m-1 p-1">
                            <div class="col-lg-4" >
                                <img src="{{asset('public/uploads/post')}}/{{$opinion->image}}" style="height: 50px; width: 100px;">
                            </div>
                            <div class="col-lg-8 daily-briefing-content">
                                <h4 style="margin-top: -2px">
                                    <a href="{{route('opinion.show',$opinion->slug_bangla)}}" style="font-family: SolaimanLipi; font-size: 16px; font-weight: 500;">{{$opinion->title_bn}}</a>
                                </h4>
                            </div>
                        </div>
                        @endforeach
                </div>
                <div class="advertisement pt-1 pb-1">
                    @php
                        $advertisements_first_side= DB::table('advertisements')->orderBy('id','ASC')->where('ads_type',2)->take(1)->get();
                    @endphp
                    @foreach ($advertisements_first_side as $advertisement_first_side)
                    <a href="{{$advertisement_first_side->ads_link}}">
                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_first_side->ads_image}}" style="width: 320px; height: 240px; margin-left: 20px;" alt="ads">
                    </a>
                    @endforeach
                </div> 
            </div>
...
<section class="default-news-area">
    <div class="container">
        <div class="row">   
            <div class="col-lg-9">
                <div class="single-new-news-box p-3" style="background-color: #eff7f7a1; margin-top: -30px;">
                    <div class="row">
                        @foreach ($six_posts as $six_post)
                        <div class="col-lg-4 col-md-4 p-2" >
                            <div class="single-most-popular-news" style="background-color: #eff7f7a1; margin-right: -15px;">
                                <div class="popular-news-image">
                                    <a href="#">
                                    <img src="{{asset('public/uploads/post')}}/{{$six_post->image}}" alt="image" style="width: 300px">
                                    </a>
                                </div>
                                <div class="popular-news-content">
                                    <h3  style="font-size: 16px; font-family: Solaiman Lipi; color: #080808; font-weight: 400; line-height:30px; ">
                                        <a href="{{route('postshow.show',$six_post->slug_bn)}}">{{$six_post->title_bn}}</a>
                                    </h3>
            ...
            <div class="col-lg-3">
                <div class="single-new-news-box pb-4"  style="background-color: #eff7f7a1; margin-left: -10px; margin-top: -30px;">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"  style="padding-left: 20px; padding-top: 20px;">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active pl-3 pr-3" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">সর্বশেষ </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link pl-5 " id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">জনপ্রিয়</a>
                        </li>
                    </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row m-1">
                            @php
                                $tab_finals= DB::table('posts')->orderBy('id', 'ASC')->skip(9)->take(8)->get();
                            @endphp
                            @foreach($tab_finals as $tab_final)
                            <div class="col-lg-4" >
                                <img src="{{asset('public/uploads/post')}}/{{$tab_final->image}}" class="mt-2" style="height: 50px; width: 100px;">
                            </div>
                            <div class="col-lg-8 daily-briefing-content">
                                <h4 style="font-size: 14px; color: #000000; font-family: Solaiman Lipi;  margin-top: 5px; font-weight: 500;">
                                    <a href="{{route('postshow.show',$tab_final->slug_bn)}}" >{{$tab_final->title_bn}}</a>
                                </h4>
                            </div>  
                            @endforeach  
                        </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="row m-1">
                                @php
                                    $tab_populars= DB::table('posts')->orderBy('id', 'ASC')->skip(14)->take(7)->get();
                                @endphp
                                @foreach($tab_populars as $tab_popular)
                                <div class="col-lg-4" >
                                    <img src="{{asset('public/uploads/post')}}/{{$tab_popular->image}}" class="mt-2" style="height: 50px; width: 100px;">
                                </div>
                                <div class="col-lg-8 daily-briefing-content">
                                    <h4 style="font-size: 15px; color: #000000; font-family: Solaiman Lipi;  margin-top: 5px; font-weight: 500;">
                                        <a href="{{route('postshow.show',$tab_popular->slug_bn)}}" >{{$tab_popular->title_bn}}</a>
                                    </h4>
...
<section class="container">
    <div class="row container" style="margin-top: -50px;">
        @foreach ($advertisements_second as $advertisement_second)
        <div class="col-lg-6">
            <a href="">
                <img src="{{asset('public/uploads/ads')}}/{{$advertisement_second->ads_image}}" style="height: 90px">
            </a> 
        </div> 
        @endforeach  
    </div>
...
<section style="background-color: black; ">
    <div class="container pt-5 pb-3">
         <h3 class="text-center text-danger">চোখ রাখুন </h3>
        <div class="row">
            @php
                $elections= DB::table('elections')->select('elections.*')->orderBy('id','DESC')->limit(8)->get();
            @endphp

            @foreach ($elections as $election)
            <div class="col-3 p-1">
                <div class="single-most-popular-news p-3" style="background-color: #090a0a00; margin-bottom: -25px; ">
                    <div class="popular-news-image">
                        <a href="#">
                        <img src="{{asset('public/uploads/election')}}/{{$election->image}}" alt="image" style="width: 300px">
                        </a>
                    </div>
                    <div class="popular-news-content">
                        <h3>
                            <a href="{{route('election.show',$election->slug_bangla)}}" style="font-size: 15px; font-family: Solaiman Lipi; color:white; font-weight: 500;">{{$election->title_bn}}</a>
                        </h3>
                    </div>
                </div>
            </div>  
...
<section class="default-news-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                @php 
                    $cat1=DB::table('categories')->first();
                    if(!$cat1==NULL){
                     $cat1bigpost = DB::table('posts')->where('cat_id', $cat1->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat1smallpost = DB::table('posts')->where('cat_id', $cat1->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat1)
                              <h2>{{ $cat1->name_bn }}  
                                <a href="{{ route('category.all.post', $cat1->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat1bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat1bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat1bigpost->slug_bn)}}">{{$cat1bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat1bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                @foreach ($cat1smallpost as $post)
                                    @if ($post->thumbnail_select == 0)
                                    <div class="row">
                                        <div class="col-lg-4" >
                                            <img src="{{asset('public/uploads/post')}}/{{$post->image}}" class="mt-3" style="height: 60px; width: 250px;">
                                        </div>
                                        <div class="col-lg-8 daily-briefing-content" style="margin-top: 15px;">
                                            <h4 style="font-size: 16px; color: #000000; font-family: Solaiman Lipi;">
                                                <a href="{{route('postshow.show',$post->slug_bn)}}">{{$post->title_bn}}</a>
                                            </h4>
                                        </div>
                                    </div>
                ...
                <div class="row container">
                    @foreach ($advertisements_third as $advertisements_third)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$advertisements_third->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
                    </div> 
                    @endforeach     
                </div><br>
                ...
                @php 
                    $cat2=DB::table('categories')->skip(1)->first();
                    if(!$cat2==NULL){
                     $cat2bigpost = DB::table('posts')->where('cat_id', $cat2->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat2smallpost = DB::table('posts')->where('cat_id', $cat2->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat2)
                              <h2>{{ $cat2->name_bn }}  
                                <a href="{{ route('category.all.post', $cat2->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat2bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat2bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat2bigpost->slug_bn)}}">{{$cat2bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat2bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row container">
                    @foreach ($advertisements_forth as $advertisements_forth)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$advertisements_forth->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
                    </div> 
                    @endforeach     
                </div><br>

            <!--Third category posts-->
                @php 
                    $cat3=DB::table('categories')->skip(2)->first();
                    if(!$cat3==NULL){
                     $cat3bigpost = DB::table('posts')->where('cat_id', $cat3->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat3smallpost = DB::table('posts')->where('cat_id', $cat3->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat3)
                              <h2>{{ $cat3->name_bn }}  
                                <a href="{{ route('category.all.post', $cat3->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat3bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat3bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat3bigpost->slug_bn)}}">{{$cat3bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat3bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row container">
                    @foreach ($advertisements_fifth as $advertisements_fifth)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$advertisements_fifth->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
                    </div> 
                    @endforeach     
                </div><br>

            <!--Fourth category posts-->
                @php 
                    $cat4=DB::table('categories')->skip(3)->first();
                    if(!$cat4==NULL){
                     $cat4bigpost = DB::table('posts')->where('cat_id', $cat4->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat4smallpost = DB::table('posts')->where('cat_id', $cat4->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat4)
                              <h2>{{ $cat4->name_bn }}  
                                <a href="{{ route('category.all.post', $cat4->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat4bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat4bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat4bigpost->slug_bn)}}">{{$cat4bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat4bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row container">
                    @foreach ($advertisements_six as $advertisements_six)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$advertisements_six->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
                    </div> 
                    @endforeach     
                </div><br>
        ...
        <!--Fiifth category posts-->
                @php 
                    $cat5=DB::table('categories')->skip(4)->first();
                    if(!$cat5==NULL){
                     $cat5bigpost = DB::table('posts')->where('cat_id', $cat5->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat5smallpost = DB::table('posts')->where('cat_id', $cat5->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat5)
                              <h2>{{ $cat5->name_bn }}  
                                <a href="{{ route('category.all.post', $cat5->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat5bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat5bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat5bigpost->slug_bn)}}">{{$cat5bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat5bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row container">
                    @foreach ($advertisements_seven as $advertisements_six)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$advertisements_six->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
          ...
          <!--DESHJURE POST-->              
                <div class="culture-news">
                    <div class="section-title" style=" margin-top: 10px;"> 
                        <h2>দেশজুড়ে 
                            <a href="#" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                        </h2> 
                    </div>
                    <div class="row">
                        @php
                            $countries = DB::table('posts')->join('divisions','posts.division_id','divisions.id')->whereNotNull('posts.division_id')
                            ->where('posts.category_first_section','1')->select('divisions.name_bn','posts.*')->first();
                        @endphp
                        @if ($countries)
                            <div class="col-lg-6">
                                <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                    <div class="culture-news-image" style="margin-top: -15px;">
                                        <a href="#">
                                        <img src="{{asset('public/uploads/post')}}/{{$countries->image}}" style="height: 250px; width: 500px;" alt="image">
                                        </a>
                                    </div><br>
                                    <div class="culture-news-content">
                                        <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                            <a href="{{route('postshow.show',$countries->slug_bn)}}">{{$countries->title_bn}}</a>
                                            <span class="badge badge-info pull-right text-white"> {{$countries->name_bn}} </span>
                                        </h3>
                                        <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                            <a href="#">{!!str_limit($countries->details_bn,'300','...')!!}</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @php
                            $countriesThumbnails = DB::table('posts')->whereNotNull('division_id')->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'desc')->limit(5)->get();
                        @endphp
                        <div class="col-lg-6">
                            @foreach ($countriesThumbnails as $countriesThumbnail) 
                                <div class="row">
                                    <div class="col-lg-4" >
                                        <img src="{{asset('public/uploads/post')}}/{{$countriesThumbnail->image}}" class="mt-3" style="height: 60px; width: 250px;">
                                    </div>
                                    <div class="col-lg-8 daily-briefing-content" style="margin-top: 15px;">
                                        <h4 style="font-size: 15px; line-height: 18px; color: #000000; font-family: Solaiman Lipi;">
                                            <a href="{{route('postshow.show',$countriesThumbnail->slug_bn)}}">{{$countriesThumbnail->title_bn}}</a>
                                        </h4>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="single-new-news-box"  style="background-color: #eff7f7a1; margin-top: -15px;">
                        <div class="row">
                            @php
                                $countriesThumbnails2 = DB::table('posts')->whereNotNull('division_id')
                                    ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'desc')->skip(5)->take(3)
                                    ->get();
                            @endphp
                            @foreach ($countriesThumbnails2 as $countryThumbnail2)
                            <div class="col-lg-4 col-md-4">
                                <div class="single-most-popular-news p-3 style=" style="background-color: #fcfdfd;">
                                    <div class="popular-news-image">
                                        <a href="#">
                                        <img src="{{asset('public/uploads/post')}}/{{$countryThumbnail2->image}}" alt="image" style="width: 350px height: 100px;">
                                        </a>
                                    </div>
                                    <div class="popular-news-content">
                                        <h3  style="font-size: 16px; font-family: Solaiman Lipi; font-color: #000000;">
                                            <a href="{{route('postshow.show',$countryThumbnail2->slug_bn)}}">{{$countryThumbnail2->title_bn}}</a>
                                        </h3>
                                    </div> 
                                </div>
                            </div>  
        ...
        @php
            $advertisement_eight= DB::table('advertisements')->where('ads_type',3)->skip(9)->take(1)->get()
        @endphp

        @foreach ($advertisement_eight as $advertisement_eight)
        <section class="widget widget_featured_reports">
            <div class="single-featured-reports">
                <div class="featured-reports-image">
                    <a href="#">
                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_eight->ads_image}}" alt="image" style="height: 100px; width: 900px;">
                    </a>
       ...
       <!--end deshjure post--> 
        ...
        <!--sixth category posts-->
                @php 
                    $cat6=DB::table('categories')->skip(5)->first();
                    if(!$cat6==NULL){
                     $cat6bigpost = DB::table('posts')->where('cat_id', $cat6->id)
                                ->where('category_first_section','1')
                                ->first();
                     $cat6smallpost = DB::table('posts')->where('cat_id', $cat6->id)
                                ->where('thumbnail_select', 0)->where('category_first_section',null)->orderBy('id', 'DESC')->limit(5)
                                ->get();           
                    }else{
                    }
                @endphp
                   <div class="culture-news">
                        <div class="section-title"> 
                            @if($cat6)
                              <h2>{{ $cat6->name_bn }}  
                                <a href="{{ route('category.all.post', $cat6->id) }}" style="float:right; font-size:12px; margin-top: 10px;">সকল খবর</a>
                              </h2>
                            @else @endif 
                        </div>
                        <div class="row">
                            ...
                            @if ($cat6bigpost)
                                <div class="col-lg-6">
                                    <div class="single-culture-news p-2"  style="background-color: #F4F6F6;  margin-top: -5px;">
                                        <div class="culture-news-image" style="margin-top: -15px;">
                                            <a href="#">
                                            <img src="{{asset('public/uploads/post')}}/{{$cat6bigpost->image}}" style="height: 250px; width: 500px;" alt="image">
                                            </a>
                                        </div><br>
                                        <div class="culture-news-content">
                                            <h3 style="font-family: SolaimanLipi; font-size: 18px; font-weight: 500; margin-top: -20px; margin-left: 15px;">
                                                <a href="{{route('postshow.show',$cat6bigpost->slug_bn)}}">{{$cat6bigpost->title_bn}}</a>
                                            </h3>
                                            <h3 style="font-family: SolaimanLipi; font-size: 12px; font-weight: 500; margin-left: 15px; line-height: 25px;">
                                                <a href="#">{!!str_limit($cat6bigpost->details_bn,'300','...')!!}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                ...
                @php
                  $ads10= DB::table('advertisements')->select('advertisements.*')->where('ads_type',3)->orderBy('id','ASC')->skip(10)->take(1)->get();
                @endphp
                <div class="row container">
                    @foreach ($ads10 as $ads10)
                    <div class="col-lg-12">
                        <a href="">
                            <img src="{{asset('public/uploads/ads')}}/{{$ads10->ads_image}}" style="height: 100px; width: 700px;">
                        </a>
                    </div> 
                    @endforeach     
                </div><br>
            ...
            <div class="row mt-3">
                @php
                    $two_categories = DB::table('categories')->skip(6)->take(2)->get();
                @endphp
                @foreach ($two_categories as $key => $two_category)
                <div class="col-lg-6">
                    <div class="section-title"> 
                        <h2>{{ $two_category->name_bn}}</h2> 
                    </div>
                    <div class="sports-slider owl-carousel owl-theme">
                        <div class="sports-item">
                            <div class="single-sports-news">
                                @php
                                    $two_categories_show = DB::table('posts')->where('cat_id', $two_category->id)->orderBy('id','DESC')->limit(5)->get();
                                @endphp
                                @foreach ($two_categories_show as $two_category_show)
                                <div class="row align-items-center">
                                    <div class="col-lg-3">
                                        <div class="tech-news-image">
                                            <a href="#">
                                                <img src="{{asset('public/uploads/post')}}/{{$two_category_show->image}}" alt="image" style="width: 120px; height:60px; margin-bottom: 25px;">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="tech-news-content">
                                            <h3 style="font-size: 15px; font-weight: 500; margin-top: -30px; font-name: SolaimanLipi; font-color: rgb(11, 13, 14)">
                                                <a href="{{route('postshow.show',$two_category_show->slug_bn)}}">{{$two_category_show->title_bn}}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>   
        ...
        @php
            $advertisements_first= DB::table('advertisements')->select('advertisements.*')->where('ads_type',3)->orderBy('id','ASC')->skip(11)->take(1)->get();
        @endphp
        @foreach ($advertisements_first as $advertisement_first)
        <section class="container mt-2" >
            <div class="row container">
                <div class="col-lg-12">
                    <a href="">
                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_first->ads_image}}" style="width: 900px; height: 100px;">
                    </a>
                </div>    
            </div>
        </section><br>
        ...
        <div class="row mt-3">
                @php
                    $othercategory = DB::table('categories')->skip(8)->take(2)->get();
                @endphp
                @foreach ($othercategory as $key => $eight_category)
                <div class="col-lg-6">
                    <div class="section-title"> 
                        <h2>{{ $eight_category->name_bn}}</h2> 
                    </div>
                    <div class="sports-slider owl-carousel owl-theme">
                        <div class="sports-item">
                            <div class="single-sports-news">
                                @php
                                    $eight_cat_show = DB::table('posts')->where('cat_id', $eight_category->id)->orderBy('id','DESC')->limit(5)->get();
                                @endphp
                                @foreach ($eight_cat_show as $two_category_show)
                                <div class="row align-items-center">
                                    <div class="col-lg-3">
                                        <div class="tech-news-image">
                                            <a href="#">
        ...
        @php
            $advertisements_first= DB::table('advertisements')->select('advertisements.*')->where('ads_type',3)->orderBy('id','ASC')->skip(12)->take(1)->get();
        @endphp
        @foreach ($advertisements_first as $advertisement_first)
        <section class="container mt-2" >
            <div class="row container">
        ...
        <div class="row mt-3">
                @php
                    $tencategory = DB::table('categories')->skip(10)->take(2)->get();
                @endphp
                @foreach ($tencategory as $key => $ten_category)
                <div class="col-lg-6">
                    <div class="section-title"> 
                        <h2>{{ $ten_category->name_bn}}</h2> 
                    </div>
                    <div class="sports-slider owl-carousel owl-theme">
                        <div class="sports-item">
                            <div class="single-sports-news">
                                @php
                                    $tencategory_show = DB::table('posts')->where('cat_id', $ten_category->id)->orderBy('id','DESC')->limit(4)->get();
                                @endphp
                                @foreach ($tencategory_show as $ten_category_shows)
                                <div class="row align-items-center">
                                    <div class="col-lg-3">
                                        <div class="tech-news-image">
                                            <a href="#">
                                                <img src="{{asset('public/uploads/post')}}/{{$ten_category_shows->image}}" alt="image" style="width: 120px; height:60px; margin-bottom: 25px;">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="tech-news-content">
                                            <h3 style="font-size: 15px; font-weight: 500; margin-top: -30px; font-name: SolaimanLipi; font-color: rgb(11, 13, 14)">
                                                <a href="{{route('postshow.show',$ten_category_shows->slug_bn)}}">{{$ten_category_shows->title_bn}}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>   
          ...
          @if($offon->photogallery==1)
            <div class="health-news mt-4">
                <div class="section-title"> 
                    <h2>ফটো গ্যালারি </h2> 
                </div>
                <div class="health-news-slides owl-carousel owl-theme">
                    @php
                        $gallereries=DB::table('image_galleries')->limit(5)->get();
                    @endphp
                    @foreach ($gallereries as $gallerery)
                    <div class="single-health-news">
                        <div class="health-news-image">
                            <a href="#">
                                <img src="{{asset('public/uploads/gallery')}}/{{$gallerery->image}}" alt="image">
                            </a>
                        </div>
                        <div class="health-news-content">
                            <h3>
                                <a href="#" style="font-size: 16px; font-weight: 500; line-height: 25px; font-name: SolaimanLipi; font-color: rgb(11, 13, 14)">{{$gallerery->title}}</a>
                            </h3>
                        </div>
                    </div>     
                    @endforeach
            ...
            @else @endif
                ...
                <div class="col-lg-4">
                    <aside class="widget-area">
                      @if($offon->facebook_page==1)  
                        ...
                        <section class="widget widget_stay_connected">
                            <h3 class="widget-title">{{$social_page->facebook_bn}} </h3>
                                <div class="fb-page" data-href="https://www.facebook.com/speeddigit/" data-tabs="hidden" data-width="" data-height="" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/speeddigit/" class="fb-xfbml-parse-ignore"><a href="{{$social_page->facebook_page}}">Speeddigit</a></blockquote>
                                </div>
                        </section>
                        @endforeach
                      @else @endif  
                        ...
                        <section class="widget widget_featured_reports">
                            <div class="single-featured-reports">
                                <div class="featured-reports-image">
                                    <a href="#">
                                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_first_side->ads_image}}" alt="image" style="height: 200px; width: 300px">
                                    </a>
                                </div>
                            </div>
                        </section>
                    ...
                    @if($offon->job==1) 
                        <section class="widget widget_latest_news_thumb p-2">
                            <div class="daily-briefing-item">
                                <div class="title" style="background-color: #dbe2e2;">
                                    <h3 class="text-left pt-3 pl-3">চাকরির খবর </h3>
                                </div>
                                @php
                                    $job_newses=DB::table('job_news')->orderBy('id','DESC')->skip(1)->take(5)->get();
                                @endphp
                                @foreach ($job_newses as $job_news)
                                <article class="item">
                                    <a href="#" class="thumb">
                                        <span class="fullimage cover" role="img">
                                            <img src="{{asset('public/uploads/jobpost')}}/{{$job_news->image}}" alt="image" style="width: 80px; height: 80px;">
                                        </span>
                                    </a>
                                    <div class="info mt-1">
                                        <h4 class="title usmall" style="font-size: 15px; font-weight: 500;"><a href="{{route('jobnews.show',$job_news->slug_bangla)}}">{{$job_news->title_bn}}</a></h4>
                                        <span style="font-size: 11px ">{{ \Carbon\Carbon::parse($job_news->published_date)->format('j F, Y')}}</span>
                                    </div>
                                </article> 
                                @endforeach
                            </div>  
                    ...
                    @else @endif
                      ...
                      @if($offon->covid19 == 1)  
                        <section class="widget widget_latest_news_thumb p-2" style="margin-top: -30px">
                        ...
                        @php
                            $side_advertisement=DB::table('advertisements')->orderBy('id','ASC')->skip(5)->take(1)->get();
                        @endphp
                        @foreach ($side_advertisement as $side_advertisement)
                        <section class="widget widget_featured_reports" style="margin-top: -15px">
                            <div class="single-featured-reports">
                                <div class="featured-reports-image">
                                    <a href="#">
                                        <img src="{{asset('public/uploads/ads')}}/{{$side_advertisement->ads_image}}" alt="image" style="height: 250px; width: 350px">
                                    </a>
                                </div>
                            </div>
                        </section>
                        @endforeach
                        <section class="widget widget_popular_posts_thumb" style="margin-top: -15px">
                            <div class="daily-briefing-item">
                                <div class="title" style="background-color: #dbe2e2;">
                                    <h3 class="text-left pt-3 pl-3">সর্বশেষ নিউজ</h3>
                                </div>
                            @php
                                $final_newses=DB::table('posts')->orderBy('id','DESC')->skip(1)->take(5)->get();
                            @endphp
                            @foreach ($final_newses as $final_news)
                            <article class="item" style="margin-bottom: 30px">
                                <a href="#" class="thumb">
                                    <span class="fullimage cover" role="img">
                                        <img src="{{asset('public/uploads/post')}}/{{$final_news->image}}" alt="image" style="width: 80px; height: 80px;">
                                    </span>
                                </a>
                                <div class="info mt-2" >
                                    <h4 class="title usmall"><a href="{{route('postshow.show',$final_news->slug_bn)}}" style="font-size: 16px; font-weight: 500;">{{$final_news->title_bn}}</a></h4>
                                   {{--  <h4 class="title usmall"><a href="#" style="font-size: 11px; font-weight: 500;">{{str_limit($final_news->details_bn,'95')}}</a></h4> --}}
                                    <span style="font-size: 11px ">{{ \Carbon\Carbon::parse($final_news->published_date)->format('j F, Y')}}</span>
                                </div>
                            </article>
                            @endforeach
                            </div>
                        ...
                        @if($offon->namaz==1)
                        <section class="widget widget_tag_cloud" style="margin-top: -15px">
                            <div class="daily-briefing-item" >
                                <div class="title" style="background-color: #dbe2e2;">
                                    <h3 class="text-left pt-3">নামাজের সময়সূচি</h3>
                                </div>
                                <div class="prayer-time"  style="">
                                    @php
                                        $prayers=DB::table('prayers')->orderBy('id','DESC')->get();
                                    @endphp
                                    <img src="{{asset('public/uploads/post/adhan.jpeg')}}" alt="" style="width: 400px; height: 130px; margin-bottom: 20px; margin-left: -10px;">
                                    <div class="row">
                                        @foreach ($prayers as $prayer)
                                        <div class="col-4" style="margin-bottom: 10px;">
                                            <h6>{{$prayer->prayer_name_bn}}</h3>
                                        </div>
                                        <div class="col-4">
                                            <h6>{{ \Carbon\Carbon::createFromTimeString($prayer->adhan)->format('g:i A')}}</h3>
                                        </div>
                                        <div class="col-4">
                                            <h6>{{ \Carbon\Carbon::createFromTimeString($prayer->iqamah)->format('g:i A')}}</h3>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <section class="widget widget_most_shared" style="margin-top: -5px;">
                            <div class="daily-briefing-item">
                            <h3 class="widget-title">সমস্ত বিভাগের খবর</h3>
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="width: 300px; enable-background:new -201 -372.5 560 776.5;" xml:space="preserve">
                                <style type="text/css">
                                    
                                    .st0{opacity:0.7;}
                                    .st1{fill:#80C2EB;}
                                    .st2{fill:none;}
                                    .st3{fill:#ec1010;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                                ...
                                <g id="rangpur">
                                <a href="{{route('division.post.show',7)}}" >
                                ...
                                <g id="sylhet">
                                    <a href="{{route('division.post.show',8)}}" >
                                ...
                                <g id="khulna">
                                    <a href="{{route('division.post.show',4)}}" >
                                ...
                                <g id="dhaka">
                                    <a href="{{route('division.post.show',3)}}" >
                                ...
                                <g id="mymensingh">
                                    <a href="{{route('division.post.show',5)}}" >
                                ...
                                <g id="rajshahi">
                                    <a href="{{route('division.post.show',6)}}" >
                                ...
                                <g id="borishal">
                                    <a href="{{route('division.post.show',1)}}" >
                                ...
                                <g id="chittagong">
                                    <a href="{{route('division.post.show',2)}}" >
                        ...
                        <section class="widget widget_instagram" style="margin-top: -15px">
                            <div class="single-block auto padding15">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form action="{{route('find.post')}}" method="GET" role="form" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control" name="subdistrict_name" id="subdistrict_name">
                                                      ...
                                                      {{--   @foreach($subdistricts as $subdistrict)
                                                        <option value="{{$subdistrict->id}}">{{$subdistrict->subdis_name_bn}} | {{$subdistrict->subdis_name_en}} </option>
                                                        @endforeach --}}
                                                    </select>
                                                </div>
                                                <div class="col-sm-6">
                        ...
                        @php
                        $advertisements_first= DB::table('advertisements')->select('advertisements.*')->orderBy('id','ASC')->skip(8)->take(1)->get();
                        @endphp
                        @foreach ($advertisements_first as $advertisement_first)
                        <section class="container" >
                            <div class="row container">
                                <div class="col-lg-12">
                                    <a href="">
                                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_first->ads_image}}" style="width: 350px; height: 250px;">
                                    </a>
                                </div>    
                            </div>
                        </section><br>
                        ...
                        <section class="widget widget_popular_posts_thumb">
                            <div class="daily-briefing-item">
                                <div class="title" style="background-color: #dbe2e2;">
                                    <h3 class="text-left pt-3 pl-3">প্রবাস</h3>
                                </div>
                            @php
                                $abroads=DB::table('abroads')->orderBy('id','DESC')->skip(1)->take(4)->get();
                            @endphp
                            @foreach ($abroads as $abroad)
                            <article class="item" style="margin-bottom: 30px">
                                <a href="#" class="thumb mt-2">
                                    <span class="fullimage cover" role="img">
                                        <img src="{{asset('public/uploads/post')}}/{{$abroad->image}}" alt="image" style="width: 80px; height: 90px;">
                                    </span>
                                </a>
                                <div class="info" >
                                    <h4 class="title usmall"><a href="{{route('abroad.show',$abroad->slug_bangla)}}" style="font-size: 16px; font-weight: 500;">{{$abroad->title_bn}}</a></h4>
                                   {{--  <h4 class="title usmall"><a href="#" style="font-size: 11px; font-weight: 500;">{{str_limit($abroad->details_bn,'95')}}</a></h4> --}}
                                    <span style="font-size: 11px ">{{ \Carbon\Carbon::parse($abroad->published_date)->format('j F, Y')}}</span>
                                </div>
                            </article>
                            @endforeach
                            </div>
                        ...
                        <section class="widget widget_popular_posts_thumb">
                            <div class="daily-briefing-item">
                                <div class="title" style="background-color: #dbe2e2;">
                                    <h3 class="text-left pt-3 pl-3">লাইফস্টাইল</h3>
                                </div>
                            @php
                                $lifestyles=DB::table('lifestyles')->orderBy('id','DESC')->skip(1)->take(4)->get();
                            @endphp
                            @foreach ($lifestyles as $lifestyle)
                            <article class="item" style="margin-bottom: 30px">
                                <a href="#" class="thumb mt-2">
                                    <span class="fullimage cover" role="img">
                                        <img src="{{asset('public/uploads/post')}}/{{$lifestyle->image}}" alt="image" style="width: 80px; height: 80px;">
                                    </span>
                                </a>
                                <div class="info">
                                    <h4 class="title usmall"><a href="{{route('lifestyle.show',$lifestyle->slug_bangla)}}" style="font-size: 16px; font-weight: 500;">{{$lifestyle->title_bn}}</a></h4>
                                   {{--  <h4 class="title usmall"><a href="#" style="font-size: 11px; font-weight: 500;">{{str_limit($lifestyle->details_bn,'90')}}</a></h4> --}}
                                    <span style="font-size: 11px ">{{ \Carbon\Carbon::parse($lifestyle->created_at)->format('j F, Y')}}</span>
                                </div>
                            </article>
                            @endforeach
                            </div>
                        ...
                        @if($offon->notice==1)
                        <section class="widget widget_popular_posts_thumb">
                            <div class="daily-briefing-item p-4">
                            <div class="title" style="background-color: #dbe2e2;">
                                <h3 class="text-left pt-3 pl-3">নোটিশ</h3>
                            </div>
                            @php
                                $notices=DB::table('notices')->orderBy('id','DESC')->limit(4)->get();
                            @endphp
                            @foreach ($notices as $notice)
                            <article class="item">
                                <div class="info" >
                                    <h4 class="title usmall"><a href="{{route('notice.show',$notice->slug_bangla)}}" style="font-size: 15px; font-weight: 500;">{{$notice->title_bn}}</a></h4>
                                    <h4 class="title usmall"><a href="#" style="font-size: 11px; font-weight: 500;">{{str_limit($notice->details_bn,'90')}}</a></h4> 
                                </div>
                                <hr class="dotted" style="border-top: 2px dotted  rgb(73, 71, 71);">
                            </article>
                            @endforeach
                            </div>
                        </section>
                        ...
                        <section class="widget widget_popular_posts_thumb">
                            <div class="daily-briefing-item p-4">
                            <div class="title" style="background-color: #dbe2e2;">
                                <h3 class="text-left pt-3 pl-3">জাগো মানবতা</h3>
                            </div>
                            @php
                                $nonprofit=DB::table('non_profits')->orderBy('id','DESC')->limit(4)->get();
                            @endphp
                            @foreach ($nonprofit as $row)
                             <article class="item" style="margin-bottom: 30px">
                                <a href="#" class="thumb mt-2">
                                    <span class="fullimage cover" role="img">
                                        <img src="{{asset('public/uploads/post')}}/{{$row->image}}" alt="image" style="width: 80px; height: 80px;">
                                    </span>
                                </a>
                                <div class="info">
                                    <h4 class="title usmall"><a href="#" style="font-size: 16px; font-weight: 500;">{{$row->title_bn}}</a></h4>
                                  
                                    <span style="font-size: 11px ">{{ \Carbon\Carbon::parse($row->end_date)->format('j F, Y')}}</span>
                                </div>
                            </article>
                            @endforeach
                            </div>
        ...
        @php
            $advertisement_sides= DB::table('advertisements')->orderBy('id','DESC')->limit(1)->get();
        @endphp
        @foreach ($advertisement_sides as $advertisement_side)
        <section class="widget widget_featured_reports mt-5">
            <div class="single-featured-reports">
                <div class="featured-reports-image">
                    <a href="#">
                        <img src="{{asset('public/uploads/ads')}}/{{$advertisement_side->ads_image}}" alt="image" style="height: 100px; width: 1000px; margin-left: 100px;">
                    </a>
                </div>
            </div>
        </section>
        ...
        <section class="m-3">
            <div class="breaking-news-content">
                <h6 class="breaking-title mr-1" style="font-size: 18px;color:rgb(0, 0, 0); margin-top: 5px; font-weight: 600; font-family: sans-serif;">
                    বিজ্ঞপ্তি : 
                </h6>
                <div class="breaking-news-slides owl-carousel owl-theme">
                    @php
                        $notices=DB::table('notices')->orderBy('id')->get();
                    @endphp
                   
                    <div class="single-breaking-news" style="background-color: #5a0505; padding: 5px;"> 
                        <marquee direction="left"onmouseover="this.stop()" onmouseout="this.start()" > @foreach ($notices as $notice)<a href="{{route('notice.show',$notice->slug_bangla)}}" style="font-family: solaimanlipi; font-size: 15px; font-weight: 400; color:rgb(245, 248, 248)">{{$notice->title_bn}} <i class='fa fa-dot-circle-o pl-1 pr-1' style="color: rgb(0, 132, 255)"></i> </a>@endforeach</marquee> 
                    </div>    
                </div>
            </div>
        </section>
        ...
        <section>
            <hr class="solid m-3" style="border-top: 4px solid rgb(12, 1, 77) ">
            <div class="row mt-4 mb-4">
                ...
                <div class="col-lg-3 col-sm-4">
                    <div class="foot-logo">
                        <a href="{{route('frontend.home-show')}}"><img src="{{asset('public/uploads/post')}}/{{$settings->logo}}"></a> 
                    </div>
                </div>
                @php
                    $social_links= DB::table('sociallinks')->orderBy('id', 'ASC')->limit(1)->get();
                @endphp 
                <div class="col-md-6 col-sm-4">
                    <ul class="top-footer-social" style="margin-left:130px;">
                        @foreach($social_links as $social_link)
                        <li>
                            <a href="{{$social_link->facebook}}" class="facebook" target="_blank" >
                                <i class='fa fa-facebook' style="background-color: #627AAD"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{$social_link->instagram}}" class="pinterest" target="_blank">
                                <i class='fa fa-instagram' style="background-color: #f03a58"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{$social_link->linkedin}}" class="pinterest" target="_blank">
                                <i class='fa fa-linkedin' style="background-color: #0b6e92"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{$social_link->twitter}}" class="twitter" target="_blank">
                                <i class='fa fa-twitter'  style="background-color: #33BDF1"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{$social_link->pinterest}}" class="pinterest" target="_blank">
                                <i class='fa fa-pinterest' style="background-color: #c00909"></i>
                            </a>
                        </li>
                        @endforeach
                    </ul>  
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="apps-img">
                        <a href="https://www.facebook.com/" target="_blank"><img src="https://news.learnhunter.live/public/image/thumbnail/5ee5d5a11e525.png" alt=""></a>
                        <a href="https://www.facebook.com/" target="_blank"><img src="https://news.learnhunter.live/public/image/thumbnail/5ee5d5cb8b96e.png" alt=""></a>
                    </div>  
                </div>  
            </div>
        </section>
...
<script>
    $("#division_name").change(function(){ 
      ...
      $.ajax({
          url: "{{ url('district-post-filter') }}"+'/'+id,
          method: 'get',
...
<script>
    $("#district_name").change(function(){
      ...
      var token = $("input[name='_token']").val(); 
      $.ajax({
          url: "{{ url('subdistrict-post-filter') }}"+'/'+id,
          method: 'get',
          success: function(data) {
            //   alert(data.options);
