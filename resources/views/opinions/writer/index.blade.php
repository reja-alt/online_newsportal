...
@section('content')
        <div class="card mr-5 ml-5 mt-5">
            <div class="card-body">
              <h1 style="margin-bottom: -25px">All Opinions</h1> 
              <a href="{{ route('opinions.create') }}" class="btn btn-sm btn-success pull-right" style="float: right; background-color: white; color: black;"><i class="fa fa-sm fa-plus" style="color: black"></i>Add Opinion</a>
          </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group" aria-label="Second group">
                                    ...
                                    <a href="{{ route('opinions.edit', $opinion->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    
                                  
                                    <a href="opinions/delete/{{$opinion->id}}" class="btn btn-sm btn-danger delete-confirm"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
