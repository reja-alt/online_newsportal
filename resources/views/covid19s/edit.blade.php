...
<div class="container p-20">
    <div class="col-md-10 mx-auto">
        <div class="tile">
            <form action="{{ route('covid19.update',$covid19->id) }}" method="POST" role="form" enctype="multipart/form-data"> 
                @csrf
                @if (count($errors) > 0)
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tile-footer">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <a class="btn btn-sm btn-danger btn-square btn-uppercase" href="{{ route('covid19.index') }}"><i class="fa fa-fw fa-sm fa-check-circle"></i>Cancel</a>
                        </div>
                    </div> 
                </div> 
            </form>
