                    ...
                    <div class="tile">
                        <form action="{{ route('category.update',$category->id) }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    ...
                                    <input class="form-control " type="text" name="name_bn" id="name_bn" value="{{$category->name_bn}}"/>
                            </div>
                            <div class="form-group">
                                    <label class="control-label" for="name">English Name <span class="m-l-5 text-danger"> * </span></label>
                                    <input class="form-control" type="text" name="name_en" id="name_en" value="{{$category->name_bn}}"/>
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">Show On Header</label>
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="category_on_header" name="category_on_header" value="1" @if($category->category_on_header ==1) checked="" @endif>
                                        <label class="form-check-label" for="headline">Show Categry On Header</label>
                                    </div>
                            </div> 
